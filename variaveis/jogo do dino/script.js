...
function dinossauro(n){
    ...
    document.getElementById('dino').innerHTML = "Seu dino:" + converterParaDinossauro(dinoEscolhido)
    document.getElementById("sorteado").innerHTML = converterParaDinossauro(dinoSorteado)
